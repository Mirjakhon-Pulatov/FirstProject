    ...
    <div class="row pt-5" data-aos="fade-up"
        ...
        <div class="col-lg-3 col-md-6 mt-3">
            ...
            <div class="d-flex flex-column justify-content-start">
                <a class="text-white-50 mb-2" href="<?php echo e(route('index')); ?>"><i class="fa fa-angle-right text-white mr-2"></i>Главная</a>
                <a class="text-white-50 mb-2" href="<?php echo e(route('about')); ?>"><i class="fa fa-angle-right text-white mr-2"></i>О нас</a>
                <a class="text-white-50 mb-2" href="<?php echo e(route('service')); ?>"><i class="fa fa-angle-right text-white mr-2"></i>Услуги</a>
                <a class="text-white-50 mb-2" href="<?php echo e(route('project')); ?>"><i class="fa fa-angle-right text-white mr-2"></i>Наши работы</a>
                <a class="text-white-50 mb-2" href="<?php echo e(route('contact')); ?>"><i class="fa fa-angle-right text-white mr-2"></i>Контакты</a>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 mt-3">
            ...
            <div class="w-100 mb-3">
                <div class="input-group">
                    <div class="input-group-append">
                        <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-primary px-6">Оставить заявку</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Footer End -->
<?php /**PATH D:\OSPanel\domains\FirstProject\resources\views/user/partials/footer.blade.php ENDPATH**/ ?>