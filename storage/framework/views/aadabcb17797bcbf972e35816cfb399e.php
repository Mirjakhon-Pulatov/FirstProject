    ...
    <div class="container-fluid bg-primary py-5 px-0" style="margin-bottom: 90px;">
        <div class="row mx-0 align-items-center">
            ...
            <div class="col-lg-6 px-0 text-right" data-aos="fade-up" data-aos-duration="1500">
                <img class="img-fluid mt-5 mt-lg-0" src="<?php echo e(asset('user/assets/img/header.png')); ?>" alt="">
            </div>
        </div>
    </div>
    <!-- Header End -->
    ...
    <div class="container-fluid pt-5" data-aos="fade-up" data-aos-duration="2000">
        ...
        <div class="container pt-5">
            <div class="row align-items-center">
                <div class="col-md-5">
                    <img style="width: 800px;"  class="img-fluid mb-lg-0" src="<?php echo e(asset('user/assets/img/img_1.jpg')); ?>" alt="">
                </div>
                <div class="col-lg-6">
                ...
                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-md-6 mb-4 portfolio-item">
                        <div style="width: 330px; height: 250px;" class="position-relative rounded overflow-hidden mb-2 mt-4">
                            <img class="img w-100 h-100" src="<?php echo e(asset('storage/'. $project->image )); ?>" alt="">
                            <div class=" d-flex align-items-center justify-content-center">
                                <a class="portfolio-btn d-flex align-items-center justify-content-center text-decoration-none" href="<?php echo e(route('view', $project->id)); ?>">
        ...
        <div class="row mx-0 justify-content-center" style="margin-top: -200px;">
            <div class="col-lg-6 col-md-8 col-sm-10 px-0">
                <div class="contact-form bg-white rounded p-5">
                    ...
                    <form action="<?php echo e(route('send_message')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\FirstProject\resources\views/user/partials/index.blade.php ENDPATH**/ ?>